...
def save_one_image_gt(im, im_id, output_filename, dataset, dpi=200, draw_bbox=False):
    ...
    # Generate random colors
    color_list = random_colors(len(anns))
    ...
    if datasetType == 'instances':
        ...
        for ann in anns:
            ...
            if 'keypoints' in ann and type(ann['keypoints']) == list:
                ...
                for sk in sks:
                    if np.all(v[sk]>0):
                        plt.plot(x[sk],y[sk], linewidth=3, color=color_mask)
                plt.plot(x[v>0], y[v>0],'o',markersize=8, markerfacecolor=color_mask, markeredgecolor='k',markeredgewidth=2)
                plt.plot(x[v>1], y[v>1],'o',markersize=8, markerfacecolor=color_mask, markeredgecolor=color_mask, markeredgewidth=2)
