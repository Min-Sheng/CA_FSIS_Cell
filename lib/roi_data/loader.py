...
class RoiDataLoader(data.Dataset):
    ...
    def sample_bg(self, im, mask, patch_sizes=[32, 64, 128], T=10000):
    ...
    def find_domain(self, category):
        domain = {
            1: "FIA", #"BBBC039"
            2: "Bright field", #"ClusterNuclei"

            3: "FIA", #"BBBC020_nuclei"
            4: "FIA", #"BBBC020_cell"
            5: "Bright field", #"TNBC"

            6: "FIA", #"MicroNet"
            7: "FIA", #"BBBC018_nuclei"
            8: "FIA", #"BBBC018_cell"

            9: "FIA", #"NucleiSeg"
            10: "Bright field", #"MoNuSeg"

            11: "FIA", #"ISBI2009"
            12: "FIA", #"BBBC007_nuclei"
            13: "FIA", #"BBBC007_cell"
            14: "Bright field", #"Hela"
        }
